...
function updateMain(){
	...
	tempTemplate = tempTemplate.replace("::metatitle::", metadata.title);
	tempTemplate = tempTemplate.replace("::metaDescription::", metadata.description);
